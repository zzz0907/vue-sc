          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="(spuSaleAttr) in spuSaleAttrList" :key="spuSaleAttr.id">
                ...
                <dd changepirce="0" @click="changeActive(spuSaleAttrValue,spuSaleAttr.spuSaleAttrValueList)" :class="{active:spuSaleAttrValue.isChecked ==1}" v-for="(spuSaleAttrValue) in spuSaleAttr.spuSaleAttrValueList" :key="spuSaleAttrValue.id">{{spuSaleAttrValue.saleAttrValueName}}</dd>
              </dl>
            </div>
            <div class="cartWrap">
              <div class="controls">
